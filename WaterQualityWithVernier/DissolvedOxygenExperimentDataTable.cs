...
{
    class DissolvedOxygenExperimentDataTable
    {
        public static void DissolvedOxygenExperimentTable()
        {
            CsvToDataTable obj = new CsvToDataTable();

            DataTable dtData = obj.ConvertCsvToDataTable(Program._config["DOExpDataFile"]);

            obj.DissolvedOxygenExperimentShowTable(dtData);
        }
